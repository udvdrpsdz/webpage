...
document.addEventListener('DOMContentLoaded', () => {
     ...
     var funct = '/.netlify/functions/page_view_counter'
     
     fetch(funct + "?page=" + encodeURIComponent(current_page), {
        method: "GET",
        headers: {
        ...
        .then((data) => {
          ...
          document.getElementById("brojPosjetitelja").textContent = viewCount;
          
        })
        .catch((error) => console.error("Error:", error));
        //(Naiv udruge) je korisnik(-ca) institucionalne podrške Nacionalne zaklade za razvoj civilnog društva za stabilizaciju i/ili razvoj udruge.-

        //Udruga dragovoljaca i veterana Domovinskog rata Republike Hrvatske - Podružnica Splitsko dalmatinske županije
        //je korisnica institucionalne podrške Nacionalne zaklade za razvoj civilnog društva za 
        //stabilizaciju i/ili razvoj udruge.
        
        //UDVDR RH PSDŽ je korisnica institucionalne podrške Nacionalne zaklade za razvoj civilnog društva za razvoj udruge.
        
        // Udruga dragovoljaca i veterana Domovinskog rata Republike Hrvatske (UDVDR RH) 
        // je korisnica Nacionalne sustavne podrške Nacionalne zaklade za razvoj civilnoga društva.
